...
//    cb.setHttpProxyPort();
    ...
    StatusListener listener = new StatusListener() { 
        ...
        public void onStatus(Status status) {
            ...
            System.out.println(status.getRetweetCount() + "@"+ status.getInReplyToStatusId() +"@" + status.getInReplyToScreenName() + "@" + status.getGeoLocation() + "@" + status.getFavoriteCount() + "@" + status.getCreatedAt() + "@" +status.getUser().getId() + "@" + status.getUser().getScreenName() + "@" + status.getId() + " __ " + status.getText());
        }
	...
	public void onStallWarning(StallWarning warning) {
      ...
      String keywords[] = {"Rahul", "Gandhi", "NaMo", "namo", "modi", "kejriwal", "arvind", "Modi", "Kejriwal", "Arvind", "Sonia", "Vishvas", "RaGa", "raga", "AK", "AAP", "BJP", "Congress", "cong", "aap", "bjp", "Sushma", "#Elections2019", "Priyanka", "sonia", "Amethi", "ElectionResults2019", "Mayawati", "Mamata", "#Verdict2019"};
